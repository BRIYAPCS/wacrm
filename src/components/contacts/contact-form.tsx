...
export function ContactForm({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- reset only when the dialog opens or the contact changes; depending on contactTags/fetchTags would clobber in-progress edits
  }, [open, contact]);
