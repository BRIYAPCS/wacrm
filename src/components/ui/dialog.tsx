  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // max-h + overflow keep a tall dialog reachable on short /
          // landscape viewports instead of clipping past the screen edges
          // (it's vertically centred). Dialogs that manage their own inner
          // scroll override these via their own className (twMerge wins).
